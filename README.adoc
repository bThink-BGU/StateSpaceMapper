...
[WARNING]
This is a *proof of concept*, will probably not work if there are funky event names, or if the hash codes of the states collide. It's also not very "engineered" at this point. Use at your own risk.
